...
| T5 | Component quotient RAM/class codes | Decoder-oracle-checked corpus projection with >= 25% clause/watch reduction and no weighted/p95 clause or literal-slot regression |
