...
| T5 | Component quotient RAM/class codes | Frozen-decoder-oracle corpus projection, strict source-to-bundle reconstruction, >= 25% clause/watch reduction, and no weighted/p95 clause or literal-slot regression |
