...
typedef struct {
  int (*notify_assignment)(void *, const int *, size_t);
  int (*notify_new_decision_level)(void *);
  int (*notify_backtrack)(void *, size_t);
  int (*check_found_model)(void *, const int *, size_t, int *);
  int (*has_external_clause)(void *, int *, int *);
  int (*add_external_clause_lit)(void *, int *);
  int (*add_reason_clause_lit)(void *, int, int *);
